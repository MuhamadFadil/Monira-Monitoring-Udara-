//Project Kelompok Air_monitoring//
//Anggota:
/*
...
//--------access ssid dengan thingsboard-------
// WiFi access point
#define WIFI_AP_NAME        "lola"
// WiFi password
#define WIFI_PASSWORD       "iin130781"

// See https://thingsboard.io/docs/getting-started-guides/helloworld/ 
// to understand how to obtain an access token
#define TOKEN               "G4GrA5BYx3OMt4nHB3tR"

// y0Zi4PsvFZ7uME7ubusJ
//check co2 G4GrA5BYx3OMt4nHB3tR
...
//-------memanggil libari DHTesp dan penenmpatan pin-pin sensor------
// DHT object
DHTesp dht;
...
void loop() {
  ...
  if (!tb.connected()) {
    ...
    Serial.println(" PPM.Send to Thingsboard.");
  ...
  // Check if it is a time to send dht11 Co2, temperature and humidity
  if (send_passed > send_delay) {
    ...
    //mq135 functionto uloads new telemetry to tingshorad using MQTT
